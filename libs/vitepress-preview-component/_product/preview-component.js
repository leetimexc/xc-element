import { openBlock as a, createElementBlock as p, createElementVNode as i, ref as _, defineComponent as Z, watch as x, createBlock as y, Transition as j, withCtx as F, normalizeClass as u, unref as n, normalizeStyle as q, createVNode as H, toDisplayString as b, createCommentVNode as M, createApp as G, computed as T, onMounted as N, resolveComponent as I, renderSlot as D } from "vue";
const V = (o, e) => {
...
const A = [], R = {
...
}, re = ["innerHTML"], ue = ["innerHTML"], pe = /* @__PURE__ */ Z({
  __name: "AntDesign",
  props: {
    code: {},
    showCode: {},
  ...
  setup(o) {
    const e = o, t = B(), { isCodeFold: c, setCodeFold: l } = O(), { copyContent: v, clickCopy: m } = z(), L = _(decodeURIComponent(e.code)), C = _(decodeURIComponent(e.showCode)), d = _(null), g = () => {
      m(L.value), R.open();
    }, f = T(() => {
      var r;
    ...
    return N(() => {
      ...
      return a(), p("div", {
        ...
        i("section", {
          ...
          e.description ? (a(), p("div", {
            key: 1,
            class: u([n(t).bem("description", "content")]),
            innerHTML: r.description
          }, null, 10, re)) : M("", !0),
          e.description || !e.title && !e.description ? (a(), p("div", {
            key: 2,
          ...
          i("div", {
            ...
            n(c) ? (a(), y(S, {
              key: 1,
              onClick: h[1] || (h[1] = (P) => n(l)(!1))
            })) : (a(), y(U, {
              key: 0,
              onClick: h[0] || (h[0] = (P) => n(l)(!0))
            })),
            H(E, { onClick: g })
          ], 2)
        ], 2),
...
const ae = ["innerHTML"], _e = /* @__PURE__ */ Z({
  ...
  setup(o) {
    const e = o, t = B(), { isCodeFold: c, setCodeFold: l } = O(), { clickCopy: v } = z(), m = _(decodeURIComponent(e.code)), L = _(decodeURIComponent(e.showCode)), C = _(null), d = () => {
      v(m.value), R.open();
    }, g = T(() => {
      var s;
